...
const externalLinks: ExternalLink[] = [
  { text: 'GitHub', url: 'https://github.com/yourusername', icon: <GitHubIcon /> },
  { text: 'LinkedIn', url: 'https://linkedin.com/in/yourusername', icon: <LinkedInIcon /> },
  { text: 'LeetCode', url: 'https://leetcode.com/yourusername', icon: <EmojiEventsIcon /> },
];
